...
set PATH=%WGET_HOME%;%ZIP7_HOME%;%WKHTMLTOPDF_HOME%;%NODE_HOME%;%NPM_HOME%;%CALIBRE_HOME%;%PATH%
...
set TITLE_PG=%DIR%\assets\TITLE_PAGE.html
...
wget --no-check-certificate -nc -O "%REDUX_ZIP%" "https://github.com/reduxjs/redux/archive/v%redux_version%.zip"
